...
SinglyLinkedListNode* insertNodeAtPosition(SinglyLinkedListNode* llist, int data) {
...
SinglyLinkedListNode* mergeLists(SinglyLinkedListNode* head1, SinglyLinkedListNode* head2) {
    ...
    SinglyLinkedListNode* mergeListTail = NULL;

    while (currHead1 != NULL && currHead2 != NULL) {
        if (currHead1->data <= currHead2->data) {
            if (mergeList == NULL) {
                mergeList = currHead1;
                mergeListTail = currHead1;
            } else {
                mergeListTail->next = currHead1;
            ...
            if (mergeList == NULL) {
                mergeList = currHead2;
                mergeListTail = currHead2;
            } else {
                mergeListTail->next = currHead2;
                mergeListTail = mergeListTail->next;
            }
